    ...
    <el-container style="height: 100%;">
        ...
        <el-main>
            <div style="max-width: 800px; margin: 0 auto;">
                ...
                <h2>主要功能</h2>
                <ul>
                    <li>课程搜索：输入空格分隔的关键词，并勾选课程名称、课程代码、课程描述或教师作为搜索范围。</li>
                    <li>已选课程管理：
                        <ul>
                ...
                <ol>
                    <li>进入首页，点击“开始排课”。</li>
                    <li>在排课页搜索框中输入关键词，选择搜索范围后加入到“已选课程”。</li>
                ...
                <ol>
                    ...
                    <li>确保在教务系统主页面打开本应用（即在 TIS 的 iframe 中），而不是直接访问 sustech-autoscheduler.pcl2.workers.dev。</li>
